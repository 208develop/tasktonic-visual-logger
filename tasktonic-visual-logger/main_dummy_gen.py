...
class DummyLogGenerator(ttTonic):
    ...
    def __init__(self, **kwargs):
        ...
        self.msg_count = 0
        self.log(lane_color='orange')

    def ttse__on_start(self):
        self.tm_burst = ttTimerRepeat(seconds=.75, name="tm_burst")
    ...
    def ttsc__burst(self, cnt):
        self.msg_count += 1
        cnt -= 1
        self.log(f"Generating log {self.msg_count}...", probe={'count': cnt})
        if cnt > 0:
